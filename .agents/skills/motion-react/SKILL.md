...
Motion publishes an LLM-friendly doc index. **Before unfamiliar APIs**, consult official docs — do not guess prop names or behavior.

1. **Find the page**: fetch `https://motion.dev/llms.txt` and search for the topic (React section lists every page).
2. **Read the page**: `WebFetch` the URL from the index (e.g. `https://motion.dev/docs/react`, `https://motion.dev/docs/react-animate-presence`).
3. **Start here**: [Get started with Motion for React](https://motion.dev/docs/react)

Common React doc paths:

| Topic                 | URL                                              |
| --------------------- | ------------------------------------------------ |
| Get started           | https://motion.dev/docs/react                    |
| Installation          | https://motion.dev/docs/react-installation       |
| Animation overview    | https://motion.dev/docs/react-animation          |
| AnimatePresence       | https://motion.dev/docs/react-animate-presence   |
| Layout                | https://motion.dev/docs/react-layout-animations  |
| Gestures / drag       | https://motion.dev/docs/react-gestures           |
| Scroll                | https://motion.dev/docs/react-scroll-animations  |
| Motion values / hooks | https://motion.dev/docs/react-motion-value       |
| Accessibility         | https://motion.dev/docs/react-accessibility      |
| Tailwind              | https://motion.dev/docs/react-tailwind           |
| Performance           | https://motion.dev/docs/performance              |
| Bundle size           | https://motion.dev/docs/react-reduce-bundle-size |

Full workflow and topic map: [references/official-docs.md](references/official-docs.md)
...
- **Official docs workflow**: [references/official-docs.md](references/official-docs.md)
